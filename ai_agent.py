...
from tools import analyze_image_with_query  # This now uses IP webcam
import langchain

# Fix for verbose attribute error
...
system_prompt = """You are NOVA — a witty, clever, and helpful assistant.
...
#     print(ask_agent(user_query="What do you see in the image?"))
